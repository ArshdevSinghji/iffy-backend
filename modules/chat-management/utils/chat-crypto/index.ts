...
export const encryptChatText = (plainText: string): string => {
  if (typeof plainText !== "string") {
    return plainText;
  }

  if (!plainText.length || isEncryptedText(plainText)) {
    return plainText;
  }
...
export const decryptChatText = (encryptedText: string): string => {
  if (typeof encryptedText !== "string" || !isEncryptedText(encryptedText)) {
